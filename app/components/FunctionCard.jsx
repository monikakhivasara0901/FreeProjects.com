    ...
    <div className="flex flex-row justify-around p-3 bg-gradient-to-r from-[#ffffff] to-[#ffffff] h-[40rem]">
      <div className="flex flex-col w-[25%] justify-center items-start ml-[10%]">
        <div className="flex flex-col justify-start items-start">
          ...
          <h6 className="text-xs mt-2 text-black"><b>Share and discover projects</b></h6>
        </div>
        <div className="flex mt-5 w-[40%]">
          <button className="flex justify-center items-center w-[100%] p-1 border-2 border-[#0F3443] bg-[#0F3443] rounded-2xl">
            Get Started
          </button>
        </div>
      </div>
